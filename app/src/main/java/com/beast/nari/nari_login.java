...
public class nari_login extends AppCompatActivity {
    ...
    private ActivityNariLoginBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = DataBindingUtil.setContentView(this, R.layout.activity_nari_login);
    ...
    private void checkUserPass() {
        ...
        StringRequest request = new StringRequest(Request.Method.POST, url,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        if (response.contains("some error occured") || response == ("some error occured")){
                            ...
                            progressDialog.dismiss();
                            Toast.makeText(nari_login.this, "user not found", Toast.LENGTH_SHORT).show();
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                progressDialog.dismiss();
                Toast.makeText(nari_login.this, "something went wrong\n" + error.getMessage(), Toast.LENGTH_SHORT).show();
        ...
        RequestQueue requestQueue = Volley.newRequestQueue(nari_login.this);
